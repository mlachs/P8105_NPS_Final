...
Based on the way we split up work we wanted to give a layout of how this project report is structured. The initial/general information about the project is given. Then each section details the individual analysis that was done. The final Appedicies include the actual work/r code that was compleated. 
...
## Shiny APP
The shiny app can be found [HERE](https://mlachs.shinyapps.io/shiny_app/). It allows you to find the various things to do based on activity catagory and other filters like reservations, pets and fees. 
## R code/ work 
